...
// ExecuteCommandRequest is used to execute arbitrary commands in the guest VM
type ExecuteCommandRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Command to execute (e.g., "/bin/sh", "/usr/bin/nvidia-smi")
	...
	// Capture stdout
	CaptureStdout bool `protobuf:"varint,6,opt,name=capture_stdout,json=captureStdout,proto3" json:"capture_stdout,omitempty"`
	// Capture stderr
	CaptureStderr bool `protobuf:"varint,7,opt,name=capture_stderr,json=captureStderr,proto3" json:"capture_stderr,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExecuteCommandRequest) GetEnv() []string {
	if x != nil {
		return x.Env
	}
	return nil
...
func (x *ExecuteCommandRequest) GetTimeout() uint32 {
	if x != nil {
		return x.Timeout
	}
	return 0
...
func (x *ExecuteCommandRequest) GetCaptureStdout() bool {
	if x != nil {
...
func (x *ExecuteCommandRequest) GetCaptureStderr() bool {
	if x != nil {
...
type ExecuteCommandResponse struct {
	...
	// Standard output (if capture_stdout was true)
	Stdout string `protobuf:"bytes,2,opt,name=stdout,proto3" json:"stdout,omitempty"`
	// Standard error (if capture_stderr was true)
...
const file_agent_proto_rawDesc = "" +
	...
	"\x14_compact_force_times\"\xd1\x01\n" +
	...
	"\atimeout\x18\x05 \x01(\rR\atimeout\x12%\n" +
	"\x0ecapture_stdout\x18\x06 \x01(\bR\rcaptureStdout\x12%\n" +
	"\x0ecapture_stderr\x18\a \x01(\bR\rcaptureStderr\"{\n" +
	"\x16ExecuteCommandResponse\x12\x1b\n" +
	"\texit_code\x18\x01 \x01(\x05R\bexitCode\x12\x16\n" +
	"\x06stdout\x18\x02 \x01(\tR\x06stdout\x12\x16\n" +
	"\x06stderr\x18\x03 \x01(\tR\x06stderr\x12\x14\n" +
	"\x05error\x18\x04 \x01(\tR\x05error2\xe1\x16\n" +
	"\fAgentService\x12G\n" +
	...
	"\tSetPolicy\x12\x16.grpc.SetPolicyRequest\x1a\x16.google.protobuf.Empty\x12K\n" +
	"\x0eExecuteCommand\x12\x1b.grpc.ExecuteCommandRequest\x1a\x1c.grpc.ExecuteCommandResponseB`Z^github.com/kata-containers/kata-containers/src/runtime/virtcontainers/pkg/agent/protocols/grpcb\x06proto3"
...
var file_agent_proto_goTypes = []any{
	...
	(*ExecuteCommandRequest)(nil),                 // 70: grpc.ExecuteCommandRequest
	(*ExecuteCommandResponse)(nil),                // 71: grpc.ExecuteCommandResponse
...
var file_agent_proto_depIdxs = []int32{
	...
	70, // 83: grpc.AgentService.ExecuteCommand:input_type -> grpc.ExecuteCommandRequest
	...
	24, // 96: grpc.AgentService.WriteStdin:output_type -> grpc.WriteStreamResponse
	26, // 97: grpc.AgentService.ReadStdout:output_type -> grpc.ReadStreamResponse
	26, // 98: grpc.AgentService.ReadStderr:output_type -> grpc.ReadStreamResponse
	81, // 99: grpc.AgentService.CloseStdin:output_type -> google.protobuf.Empty
	81, // 100: grpc.AgentService.TtyWinResize:output_type -> google.protobuf.Empty
	77, // 101: grpc.AgentService.UpdateInterface:output_type -> types.Interface
	34, // 102: grpc.AgentService.UpdateRoutes:output_type -> grpc.Routes
	33, // 103: grpc.AgentService.ListInterfaces:output_type -> grpc.Interfaces
	34, // 104: grpc.AgentService.ListRoutes:output_type -> grpc.Routes
	81, // 105: grpc.AgentService.AddARPNeighbors:output_type -> google.protobuf.Empty
	43, // 106: grpc.AgentService.GetIPTables:output_type -> grpc.GetIPTablesResponse
	45, // 107: grpc.AgentService.SetIPTables:output_type -> grpc.SetIPTablesResponse
	64, // 108: grpc.AgentService.GetMetrics:output_type -> grpc.Metrics
	81, // 109: grpc.AgentService.MemAgentMemcgSet:output_type -> google.protobuf.Empty
	81, // 110: grpc.AgentService.MemAgentCompactSet:output_type -> google.protobuf.Empty
	81, // 111: grpc.AgentService.CreateSandbox:output_type -> google.protobuf.Empty
	81, // 112: grpc.AgentService.DestroySandbox:output_type -> google.protobuf.Empty
	81, // 113: grpc.AgentService.OnlineCPUMem:output_type -> google.protobuf.Empty
	81, // 114: grpc.AgentService.ReseedRandomDev:output_type -> google.protobuf.Empty
	50, // 115: grpc.AgentService.GetGuestDetails:output_type -> grpc.GuestDetailsResponse
	81, // 116: grpc.AgentService.MemHotplugByProbe:output_type -> google.protobuf.Empty
	81, // 117: grpc.AgentService.SetGuestDateTime:output_type -> google.protobuf.Empty
	81, // 118: grpc.AgentService.CopyFile:output_type -> google.protobuf.Empty
	60, // 119: grpc.AgentService.GetOOMEvent:output_type -> grpc.OOMEvent
	81, // 120: grpc.AgentService.AddSwap:output_type -> google.protobuf.Empty
	81, // 121: grpc.AgentService.AddSwapPath:output_type -> google.protobuf.Empty
	82, // 122: grpc.AgentService.GetVolumeStats:output_type -> grpc.VolumeStatsResponse
	81, // 123: grpc.AgentService.ResizeVolume:output_type -> google.protobuf.Empty
	81, // 124: grpc.AgentService.SetPolicy:output_type -> google.protobuf.Empty
	71, // 125: grpc.AgentService.ExecuteCommand:output_type -> grpc.ExecuteCommandResponse
